<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ElectionSummary.aspx.cs" Inherits="Admin_ElectionSummary" %>
...
<div class="Election_Process"  style=" position:absolute; right:290px; top:300px; height:550px; width:600px;  text-align:left; padding:20px; border:5px solid #9999FF; border-radius:5px" bgcolor="white" 
    ...
    <asp:Image ID="Voting_img" runat="server" CssClass="img" style="position:absolute; left:120px"
                ...
                &nbsp; <asp:Label ID="Voting_lbl" runat="server" Font-Bold="True"  CssClass="hit-the-floor"
                     ...
                     Text="Election Summary" Width="300px"></asp:Label>
                       <asp:Button ID="Select_btn" runat="server" Text="Update Status" OnClick="Select_btn_Click" style="margin-top:50px;margin-left:-40px" CssClass="vote_btn" Width="130px" ValidationGroup="abc" />
    ...
    <th style="width:100px; height:20px; text-align:center">Election Date</th>
    <th style="width:100px; height:20px; text-align:center">State Name</th>
    <th style="width:100px ; height:20px; text-align:center">Total votes</th>
    <th style="width:100px ; height:20px; text-align:center">Winner</th>
    </tr>
    </HeaderTemplate>
    <ItemTemplate>
    <tr>
    <td style="text-align:center; border:1px solid #9999ff">
        <asp:Label ID="State_lbl" runat="server" Text='<%# Eval("ElectionDate") %>'></asp:Label>
    </td>
    <td  style="text-align:center; border:1px solid #9999ff">
        <asp:Label ID="Post_lbl" runat="server" Text='<%# Eval("StateName") %>'></asp:Label>
    </td>
    <td  style="text-align:center; border:1px solid #9999ff">
        <asp:Label ID="Startdate_lbl" runat="server" Text='<%# Eval("TotalVotes") %>'></asp:Label>
    </td>
    <td  style=" text-align:center; border:1px solid #9999ff">
        <asp:Label ID="Enddate_lbl" runat="server" Text='<%# Eval("PartyName") %>'></asp:Label>
    </td>
    </tr>
    </ItemTemplate>
    <FooterTemplate>
